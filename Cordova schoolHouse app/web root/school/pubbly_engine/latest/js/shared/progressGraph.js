function ProgressGraph(type, container, enginePathPrefix) {
    this.elem = false;
            ...
            html: `
                <div class='transformCenterCont'>
                    <div class='transformCenter'>
                        ...
                        <img class='positionImg' src='` + this.enginePathPrefix + `pubbly_engine/shared/logos/logoEmptyColors.png' />
                        <!-- The other to actually display, and overlay the colored blocks below -->
                        <img class='displayImg' src='` + this.enginePathPrefix + `pubbly_engine/shared/logos/logoEmptyColors.png' />
                        <div class='text_cont'>
