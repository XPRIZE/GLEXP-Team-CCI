...
//    }
    ...
    function bufferElement(type, name, location) {
        ...
        } else if (type == "audio" || type == "recording") {
            if (!document.getElementById(name) || type == "recording") {
                ...
                // duct tape
                // Wouldn't it be better if the playback things were visible, but only after there was an actual recording behind them?
                if (aud.type == "recording") {
                    var linkName = false;
                    if (typeof book[location].linkKey['play link'] !== "undefined") {
                        linkName = 'play link';
                ...
                if (aud.type == "recording") {
                    book[location].recordings[name] = src;
                }
                dry = src;
                aud.src = src;
            } else {
