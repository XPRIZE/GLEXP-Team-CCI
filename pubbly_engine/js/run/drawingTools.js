/*
    Feature addition for Xprize specifically, because someone somewhere said "What about drawing stuffs, that's educational".

    Basic paint type drawing tools, a pencil a pen, an erasor, some chalk, just the basic stuff you need for kids to finger out some letters

    All tool functions are here, effects as well, and they call back to the ctx canvas they need to be drawing on.
*/
