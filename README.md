...
* [Pubbly Design Tools](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_design_tools)

A cross platform desktop application used to design interactive eBooks.

* [Pubbly Engine](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_engine)
...
* [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console)

A LAMP CMS used to template and manage "exports" created from the design tools.

* [Pubbly SchoolHouse](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_schoolhouse)
...
* [Pubbly Submission Installation](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_submission_installation)
...
[Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Adding content: Uploading to Static"
* Template for mass production
[Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Adding content: Uploading to Variable"
...
[Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Assembling content: Stitching"
* Mapping out multiple books and link them together
[Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Assembling content: Mapping"

All content on a console can be downloaded and re-edited in the Design Tools. For help doing that, see [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Downloading/Editing content".

### Submission from scratch: Content deployment

Once all content for your program has been finished, you can create and deploy "packets". A "packet" is an export, ready to be hosted on a website or wrapped into an APK. You can create packets from Static/Variable exports, from an entire school hierarchy of Stitched Exports, and from an entire Map. For instructions, see [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Creating packets"
...
The second easiest way to modify our existing submission is to duplicate not only our console code base, but all xprize related content as well. First, create a new empty [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) (section "Getting started"). Then, download and concatenate the split zip files hosted at [Pubbly_Console_Content](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console_content). There are four split zip files, and one sql import file.  Log into your console, manually upload and unzip the Xprize console content zips to their local folders, and import an associated sql file.
...
> Add the base sql structure if you haven't already (i.e. finish [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Getting started")
> Download content zips from the [Pubbly_Console_Content](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console_content) repo to a local folder
* cd ~/
* mkdir tmp
* cd tmp
* git clone https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console_content
...
For how this content can be supplemented, edited, modified, or removed from the console, see [Pubbly Console](https://github.com/XPRIZE/GLEXP-Team-CCI/tree/master/pubbly_console) section "Adding content" 
