/*
Cursor libraries for every possibly "event" in the pubbly-verse
If you're "dragging" something, use this cursor to communicate it. and so on.
*/
class Cursors {
    // set("drag", "default")
    // set("drag", "hover")
    ...
    construct_library() {
        this.library = {
            ...
            drag: {
                "drop": "grabbing",
                "no-drop": "grabbing" // They didn't like it :(
            },
            line: {
