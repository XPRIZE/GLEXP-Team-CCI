/*
Another big area that didn't see much use

Pubblys were originally modeled to look like 2 page books. I.e. page 3 turned over on page 2 to reveal the next set of two pages (with page 1 and page last being single page cover images)

Had to animate the pages nicely across the screen to give it a unique turning look.

But since kids in Tanzania didn't have a whole lot of books for reference, NY was concerned the turning effect would just blow their minds so hard and they wouldn't learn anything.

So whatever. Still at least gets some use for non-xprize built content
*/
