function Events(pubblyScope) { // Scopped contstants are _InitCapsCamelCase
    ...
    // Ability to totally disable all events on page... Used for page loading.
    this.enabled = false;
    ...
    function attach() {
        // Why? Because jquery tries to preventDefault no matter what
        // And if it can't (scroll lock), then it doesn't call back at all...
        // And we at least want the freaking e.
        ...
        ["mousemove", "touchmove"].forEach(function (e) {
            _Pubbly.dom.canvases[0].addEventListener(e, moveHandler, false);
        });
        ["mousedown", "touchstart"].forEach(function (e) {
            _Pubbly.dom.canvases[0].addEventListener(e, downHandler, false);
        });
        ["mouseup", "mouseout", "touchend"].forEach(function (e) {
            _Pubbly.dom.canvases[0].addEventListener(e, upHandler, false);
        });
