...
var offers = [
  {
    id: 1,
    direction: "<b>Tallin</b> EE - <b>Berlin</b> Tegel DE",
    date: new Date(2014, 7, 25),
    price: "450",
    save: "45",
    places: 21
  },
  {
    id: 2,
    direction: "<b>Moscow</b> Vnukovo RU - <b>Kiev</b> Borispol UA",
    date: new Date(2014, 7, 28),
    price: "160",
    save: "65",
    places: 5
  },
  {
    id: 3,
    direction: "<b>Riga</b> International LV - <b>Warsaw</b> Modlin",
  ...
  {
    id: 4,
    direction: "<b>Vilnius</b> LT - <b>Kiev</b> Zhulhany UA",
  ...
  {
    id: 5,
    direction: "<b>Minsk</b> International 2 BY- <b>Berlin</b> Schoenefeld DE",
  ...
  {
    id: 6,
    direction: "<b>St. Petersburg</b> Pulkovo - <b>Tallin</b> Estonia",
  ...
  {
    id: 7,
    direction: "<b>Kiev</b> Zhulhany UA - <b>Moscow</b> Vnukovo RU",
  ...
  {
    id: 8,
    direction: "<b>Moscow</b> Sheremetyevo RU - <b>Vilnius</b> LT",
  ...
  {
    id: 9,
    direction: "<b>Warsaw</b> PL - <b>Minsk</b> International 2 BY",
  ...
  {
    id: 10,
    direction: "<b>Prague</b> CZ - <b>St. Petersburg</b> Pulkovo",
    date: new Date(2014, 7, 30),
    price: "311",
    save: "63",
    places: 15
  },
  ...
  {
    id: 21,
    direction: "<b>Minsk</b> International 2 BY - <b>Berlin</b> Tegel DE",
  ...
  {
    id: 22,
    direction: "<b>Vilnius</b> LT - <b>Berlin</b> Tegel DE",
      ...
      rows: [
        {
          view: "form", elements: [
          {
            ...
            id: "radio1",
            value: 1,
            options: [{id: 1, value: "One-Way"}, {id: 2, value: "Return"}],
            label: "Trip"
          },
          ...
          elements: [
            {view: "text", label: "Where", labelPosition: "top", placeholder: "Location e.g. country, city"},
            {
              cols: [
                {
                  view: "datepicker",
                  label: "I'm picking up the car on",
                  labelPosition: "top",
                  value: new Date(),
                  format: "%d  %M %Y"
                },
            ...
            },
            {
              cols: [
                {
                  view: "datepicker",
                  label: "I'm returning the car on",
                  labelPosition: "top",
                  value: new Date(),
                  format: "%d  %M %Y"
                },
