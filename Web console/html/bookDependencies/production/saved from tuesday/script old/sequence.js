          ...
          if (targDest.functionType == "chooseAndRemove" || targDest.functionType == "choose") {
            if (targDest.args.length > 0) {
              ...
              if (targDest.functionType == "chooseAndRemove") {
                curTarg[2].args.splice(rand, 1); // Remove from actual book object
              ...
              book.bugs.log("Sequence problem: Ran out of arguments for random choice.");
              functionPass = false;
            }
          } else {
            ...
            if (targAction == "show" || targAction == "hide") {
                ...
                if (lnkInKey) {
                  ...
                  if (lnkTypeArr) {
                    ...
                    if (lnkAct) {
                      ...
                      book.bugs.log("Sequence problem: link not found in <b>" + lnkType + "</b>");
                      THIS.next();
                    }
                  } else {
              ...
              if (splitTarg[0] == 'move') {
                ...
                if (objSel) {
                  ...
                  book.bugs.log("Sequence problem: Object <b>" + targDest + "</b> not found on page");
                  THIS.next();
                }
