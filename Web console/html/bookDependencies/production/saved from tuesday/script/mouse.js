...
function actionCheck(page, mX, mY, isHover, isDrag, isDraw) {
	if (page && page.loaded) {
		...
		// Don't judge me, it's god damn saturday night.
		// Seriously though, the link isn't broken. Changes made to actionArr ripple back to the actual book shit. So either fix that problem or... this.
		var actionArr = JSON.parse(JSON.stringify(actionArr));
