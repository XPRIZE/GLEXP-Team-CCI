        ...
        switch (check) {
            ...
            case "drawing tool":
                if (lowerType == "drawing tool") {
                    ...
                    // With a width of 40, whatever fucky ou
                }
                break;
            case "gif":
                ...
                if (lowerType == "wait") {
                    ...
                    if (isNaN(mess.destination * 1)) {
                        if (mess.destination.toLowerCase() == "static") {
                            curBlocking = ["gifs", "flashes", "animations", "sequences"];
                            curDest = "static";
                        } else if (mess.destination.toLowerCase() == "silence") {
                            curBlocking = "audios"; // TODO: Change to array of ["audios","highlighter","video"]
                            curDest = "silence";
                        } else {
