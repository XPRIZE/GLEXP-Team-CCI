            ...
            for (let p = 0; p < pageNodes.length; p++) {
                ...
                for (let o = 0; o < objNodes.length; o++) {
                    ...
                    if (objSets[type]) {
                        ...
                        curPage.objKey[curObj.name] = curPage.objs.push(curObj) - 1; // ArRaYs StArT aT zErO
                    } else {
                ...
                for (let l = 0; l < linkNodes.length; l++) {
                    ...
                    curLink.init.enabled = curLink.enabled + "";
                    curLink.init.drawing = curLink.drawing + "";
                    curLink.init.pinned = curLink.pinned + "";
                    ...
                    curPage.linkKeys[curLink.name] = locInArray;
                }
